...
export default async function PublicLeaderboardPage({ searchParams }: PageProps) {
  const { dimensionId, page: pageParam, limit: limitParam } = await searchParams
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {leaderboardData.map((entry) => (
                          <TableRow key={`${entry.archiveId}:${entry.playerId}`}>
                            <TableCell>
                            ...
                            <TableCell>{entry.archiveName}</TableCell>
